-- 騎手マスタ NoPK
CREATE TABLE IF NOT EXISTS JockeyMaster_NoPK (
    -- データ区分 
    ...
    -- 騎手抹消区分 
    jockeyCancellationCategory TEXT NULL,
    -- 騎手免許交付年月日 
    jockeyLicenseIssuanceDate TEXT NULL,
    -- 騎手免許抹消年月日 
    jockeyLicenseCancellationDate TEXT NULL,
    -- 生年月日 
    birthDate TEXT NULL,
    -- 騎手名 
    jockeyName TEXT NULL,
    -- 騎手名半角ｶﾅ 
    jockeyNameKana TEXT NULL,
    -- 騎手名略称 
    jockeyNameAbbreviation TEXT NULL,
    -- 騎手名欧字 
    jockeyNameEng TEXT NULL,
    -- 性別区分 
    genderCategory TEXT NULL,
    -- 騎乗資格コード 
    ridingQualificationCode TEXT NULL,
    -- 騎手見習コード 
    apprenticeJockeyCode TEXT NULL,
    -- 騎手東西所属コード 
    jockeyRegionAffiliationCode TEXT NULL,
    -- 招待地域名 
    invitationRegionName TEXT NULL,
    -- 所属調教師コード 
    affiliatedTrainerCode TEXT NULL,
    -- 年月日場回日R 
    FirstRideInfo_flat_datePlaceDayR TEXT NULL,
    -- 出走頭数 
    FirstRideInfo_flat_numberOfRunners INTEGER NULL,
    -- 血統登録番号 
    FirstRideInfo_flat_bloodlineNumber TEXT NULL,
    -- 確定着順 
    FirstRideInfo_flat_confirmedPlacement INTEGER NULL,
    -- 異常区分コード 
    FirstRideInfo_flat_abnormalityCode TEXT NULL,
    -- 年月日場回日R 
    FirstRideInfo_obstacle_datePlaceDayR TEXT NULL,
    -- 出走頭数 
    FirstRideInfo_obstacle_numberOfRunners INTEGER NULL,
    -- 血統登録番号 
    FirstRideInfo_obstacle_bloodlineNumber TEXT NULL,
    -- 確定着順 
    FirstRideInfo_obstacle_confirmedPlacement INTEGER NULL,
    -- 異常区分コード 
    FirstRideInfo_obstacle_abnormalityCode TEXT NULL,
    -- 年月日場回日R 
    FirstVictoryInfo_flat_datePlaceDayR TEXT NULL,
    -- 出走頭数 
    FirstVictoryInfo_flat_numberOfRunners INTEGER NULL,
    -- 血統登録番号 
    FirstVictoryInfo_flat_bloodlineNumber TEXT NULL,
    -- 年月日場回日R 
    FirstVictoryInfo_obstacle_datePlaceDayR TEXT NULL,
    -- 出走頭数 
    FirstVictoryInfo_obstacle_numberOfRunners INTEGER NULL,
    -- 血統登録番号 
    FirstVictoryInfo_obstacle_bloodlineNumber TEXT NULL,
    -- 年月日場回日R 
